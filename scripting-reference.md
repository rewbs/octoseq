...
Pre-populated namespace with time-based signals.

| Property | Type | Description |
|----------|------|-------------|
| `seconds` | `Signal` | Elapsed time in seconds |
| `frames` | `Signal` | Frame counter |
| `beats` | `Signal` | Continuous beat position |
| `phase` | `Signal` | Phase within current beat (0–1) |
| `bpm` | `Signal` | Beats per minute |
| `dt` | `Signal` | Delta time per frame |
