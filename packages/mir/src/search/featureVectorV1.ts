...
export function writeFingerprintToFeatureVectorRawV1(
  ...
  if (layout.melContrast) {
    out.fill(
      0,
      offset + layout.melContrast.offset,
      offset + layout.melContrast.offset + layout.melContrast.length
    );
  }
  if (layout.onsetContrast) {
    out.fill(
      0,
      offset + layout.onsetContrast.offset,
      offset + layout.onsetContrast.offset + layout.onsetContrast.length
    );
  }
