...
import { applyBandMaskToSpectrogram, computeFrameAmplitude } from "./bandMask";
...
function computeDiagnostics(energyRetainedPerFrame: Float32Array): BandMirDiagnostics {
