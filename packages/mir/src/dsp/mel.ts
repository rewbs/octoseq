...
function cpuMelProject(spec: Spectrogram, filters: Float32Array[]): MelSpectrogram {
...
export async function melSpectrogram(
  ...
  const filters = buildMelFilterBank(spec.sampleRate, spec.fftSize, config.nMels, fMin, fMax);
