...
export type MirWorkerInMessage =
  MirWorkerInitMessage | MirWorkerRunMessage | MirWorkerSearchMessage | MirWorkerCancelMessage;
...
export type MirWorkerResultMessage = {
  ...
  result: {
    ...
    activityLevel?: ArrayBufferLike;
    isActive?: ArrayBufferLike;
    suppressMask?: ArrayBufferLike;
    activityDiagnostics?: MirActivityDiagnostics;
    meta: MirResult["meta"];
  };
};
