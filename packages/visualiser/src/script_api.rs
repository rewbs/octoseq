    ...
    ScriptApiMetadata {
        ...
        globals: vec![
            ...
            ApiGlobal {
                ...
                description: "Scene camera controls. Position, rotation, projection with signal support for audio-reactive camera motion.".to_string(),
            },
        ],
        types: vec![
            // Core value shapes
            ...
            ApiType {
                ...
                properties: vec![
                    ...
                    ApiProperty {
                        name: "composedSignals".to_string(),
                        type_name: "ComposedSignals".to_string(),
                        description: "Human-authored interpretation curves (keyframe envelopes), keyed by name: `inputs.composedSignals[\"intensity\"]` returns a Signal.".to_string(),
                        readonly: true,
                        optional: true,
                    },
                ],
            ...
            ApiType {
                name: "ComposedSignals".to_string(),
                kind: ApiTypeKind::Opaque,
                description: "Composed signal accessors (string-keyed map). Each entry is a human-authored interpretation curve; indexing by name returns a Signal.".to_string(),
                properties: vec![],
                methods: vec![],
            },
            ApiType {
            ...
            ApiType {
                name: "Camera".to_string(),
                kind: ApiTypeKind::Struct,
                description: "Scene camera with signal-bindable properties. Position, rotation, projection parameters can all be driven by Signals for audio-reactive camera motion.".to_string(),
                properties: vec![
                    ApiProperty {
                        name: "position".to_string(),
                        type_name: "Vec3".to_string(),
                        description: "Camera position in world space. Each component (x, y, z) accepts numbers or Signals.".to_string(),
                        readonly: false,
                        optional: false,
                    },
                    ApiProperty {
                        name: "rotation".to_string(),
                        type_name: "Vec3".to_string(),
                        description: "Camera rotation in Euler angles (pitch, yaw, roll) in radians. Used in Euler mode (when target is not set).".to_string(),
                        readonly: false,
                        optional: false,
                    },
                    ApiProperty {
                        name: "target".to_string(),
                        type_name: "Vec3 | unit".to_string(),
                        description: "Look-at target position. Set to enable LookAt mode (camera orientation derived automatically). Set to () for Euler mode.".to_string(),
                        readonly: false,
                        optional: true,
                    },
                    ApiProperty {
                        name: "up".to_string(),
                        type_name: "Vec3".to_string(),
                        description: "Up vector for LookAt mode. Defaults to Y-up (0, 1, 0).".to_string(),
                        readonly: false,
                        optional: false,
                    },
                    ApiProperty {
                        ...
                        description: "Field of view in degrees. Default: 45.".to_string(),
                        readonly: false,
                        optional: false,
                    },
                    ApiProperty {
                        name: "near".to_string(),
                        type_name: "float | Signal".to_string(),
                        description: "Near clip plane distance. Default: 0.1.".to_string(),
                        readonly: false,
                        optional: false,
                    },
                    ApiProperty {
                        name: "far".to_string(),
                        type_name: "float | Signal".to_string(),
                        description: "Far clip plane distance. Default: 100.".to_string(),
                        readonly: false,
                        optional: false,
                    },
                ],
                methods: vec![
                    ApiMethod {
                        ...
                        description: "Set the camera to look at a target position. Enables LookAt mode.".to_string(),
                        params: vec![ApiParam {
                            name: "target".to_string(),
                            type_name: "Vec3".to_string(),
                            description: "World-space position to look at.".to_string(),
                            optional: false,
                            default: None,
                        }],
                        returns: "void".to_string(),
                        overload_id: None,
                        example: Some("camera.lookAt(#{ x: 0.0, y: 0.0, z: 0.0 });".to_string()),
                        notes: None,
                    },
                    ApiMethod {
                        name: "orbit".to_string(),
                        description: "Position camera on circular orbit around a center point. Sets both position and target.".to_string(),
                        params: vec![
                            ApiParam {
                                name: "center".to_string(),
                                type_name: "Vec3".to_string(),
                                description: "World-space position to orbit around.".to_string(),
                                optional: false,
                                default: None,
                            },
                            ApiParam {
                                ...
                                type_name: "float | Signal".to_string(),
                                description: "Distance from center.".to_string(),
                                optional: false,
                                default: None,
                            },
                            ApiParam {
                                ...
                                type_name: "float | Signal".to_string(),
                                description: "Angle in radians around Y-axis.".to_string(),
                                optional: false,
                                default: None,
                            },
                        ],
                        returns: "void".to_string(),
                        overload_id: None,
                        example: Some("camera.orbit(#{ x: 0.0, y: 0.0, z: 0.0 }, 5.0, time.seconds * 0.5);".to_string()),
                        notes: None,
                    },
                    ApiMethod {
                        name: "dolly".to_string(),
                        description: "Move camera forward/backward along view direction.".to_string(),
                        params: vec![ApiParam {
                            name: "distance".to_string(),
                            type_name: "float | Signal".to_string(),
                            description: "Distance to move (positive = forward).".to_string(),
                            optional: false,
                            default: None,
                        }],
                        returns: "void".to_string(),
                        overload_id: None,
                        example: Some("camera.dolly(inputs.energy.scale(2.0));".to_string()),
                        notes: None,
                    },
                    ApiMethod {
                        name: "pan".to_string(),
                        description: "Move camera laterally (left/right, up/down).".to_string(),
                        params: vec![
                            ApiParam {
                                name: "dx".to_string(),
                                type_name: "float | Signal".to_string(),
                                description: "Horizontal movement (positive = right).".to_string(),
                                optional: false,
                                default: None,
                            },
                            ApiParam {
                                name: "dy".to_string(),
                                type_name: "float | Signal".to_string(),
                                description: "Vertical movement (positive = up).".to_string(),
                                optional: false,
                                default: None,
                            },
                        ],
                        returns: "void".to_string(),
                        overload_id: None,
                        example: Some("camera.pan(0.5, 0.0);".to_string()),
                        notes: None,
                    },
                ],
            },
