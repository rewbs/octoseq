...
export const SIGNAL_ENTRIES: RegistryEntry[] = [
  ...
  // ============================================================================
  {
    ...
    methods: [
      ...
      {
        name: "impulse",
        path: "EventStream.impulse",
        description: "Convert events to an impulse Signal (alias for to_signal()).",
        params: [],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let impulses = events.impulse();",
      },
      // === Temporal Distance Methods ===
      {
        ...
        returns: "Signal",
        chainsTo: "Signal",
        example: "let distance = events.beats_from_prev();",
      },
      {
        name: "beats_to_next",
        ...
        returns: "Signal",
        chainsTo: "Signal",
        example: "let anticipation = events.beats_to_next();",
      },
      {
        name: "seconds_from_prev",
        path: "EventStream.seconds_from_prev",
        description: "Signal representing seconds elapsed since previous event.",
        params: [],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let distance = events.seconds_from_prev();",
      },
      {
        name: "seconds_to_next",
        path: "EventStream.seconds_to_next",
        description: "Signal representing seconds remaining until next event.",
        params: [],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let anticipation = events.seconds_to_next();",
      },
      {
        name: "frames_from_prev",
        path: "EventStream.frames_from_prev",
        description: "Signal representing frames elapsed since previous event.",
        params: [],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let distance = events.frames_from_prev();",
      },
      {
        name: "frames_to_next",
        path: "EventStream.frames_to_next",
        description: "Signal representing frames remaining until next event.",
        params: [],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let anticipation = events.frames_to_next();",
      },
      // === Event Count Methods ===
      {
        name: "count_prev_beats",
        path: "EventStream.count_prev_beats",
        description: "Count events in the previous N beats.",
        params: [{ name: "window", type: "float | Signal", description: "Window size in beats." }],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let recent = events.count_prev_beats(4.0);",
      },
      {
        name: "count_next_beats",
        path: "EventStream.count_next_beats",
        description: "Count events in the next N beats.",
        params: [{ name: "window", type: "float | Signal", description: "Window size in beats." }],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let upcoming = events.count_next_beats(4.0);",
      },
      {
      ...
      {
        name: "count_prev_frames",
        path: "EventStream.count_prev_frames",
        description: "Count events in the previous N frames.",
        params: [{ name: "window", type: "float | Signal", description: "Window size in frames." }],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let recent = events.count_prev_frames(60);",
      },
      {
        name: "count_next_frames",
        path: "EventStream.count_next_frames",
        description: "Count events in the next N frames.",
        params: [{ name: "window", type: "float | Signal", description: "Window size in frames." }],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let upcoming = events.count_next_frames(60);",
      },
      // === Event Density Methods ===
      {
        name: "density_prev_beats",
        path: "EventStream.density_prev_beats",
        description: "Event density (events per beat) in the previous N beats.",
        params: [{ name: "window", type: "float | Signal", description: "Window size in beats." }],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let density = events.density_prev_beats(4.0);",
      },
      {
        name: "density_next_beats",
        path: "EventStream.density_next_beats",
        description: "Event density (events per beat) in the next N beats.",
        params: [{ name: "window", type: "float | Signal", description: "Window size in beats." }],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let density = events.density_next_beats(4.0);",
      },
      {
      ...
      // === Phase Method ===
      {
        name: "beat_phase_between",
        path: "EventStream.beat_phase_between",
        description: "Phase between adjacent events: 0 at previous event, 1 at next event.",
        params: [],
        returns: "Signal",
        chainsTo: "Signal",
        example: "let phase = events.beat_phase_between();",
        notes: "Useful for smooth animations that reset at each event.",
      },
      {
        name: "filter_time",
  ...
  // ============================================================================
  {
    ...
    properties: [
      ...
      {
        name: "centroid",
        path: "BandSignals.centroid",
        type: "Signal",
        description: "Band spectral centroid (brightness).",
        readonly: true,
      },
      {
        name: "amplitude",
      ...
      },
      {
        ...
        type: "EventStream",
        description: "Band-scoped events (legacy, prefer beatCandidates/onsetPeaks).",
        readonly: true,
      },
      {
        name: "beatCandidates",
        path: "BandSignals.beatCandidates",
        type: "EventStream",
        description: "Beat candidate events for this band.",
        readonly: true,
      },
      {
        name: "onsetPeaks",
        path: "BandSignals.onsetPeaks",
        type: "EventStream",
        description: "Onset peak events for this band.",
        readonly: true,
      },
    ],
    methods: [],
