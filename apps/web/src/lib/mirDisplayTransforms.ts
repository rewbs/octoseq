 ...
 */
export function prepareHpssSpectrogramForHeatmap(
  magnitudes2d: Heatmap2D,
  options: HpssDisplayOptions = {}
): Heatmap2D {
 ...
 */
export function prepareMfccForHeatmap(
  coeffs2d: Heatmap2D,
  options: MfccDisplayOptions = {}
): Heatmap2D {
