...
export function MusicalTimePanel({
  ...
  const segments = useMemo(() => structure?.segments ?? [], [structure?.segments]);
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  {/* Beat count */}
                  <div className="text-xs text-zinc-400 dark:text-zinc-500">~{beatCount} beats</div>
                </div>
      ...
      <div className="p-2 border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50/50 dark:bg-zinc-800/50">
        <div className="text-xs text-zinc-500 dark:text-zinc-400 mb-1">
          ...
          {draggingBoundaryIndex !== null && dragPreviewTime !== null && (
            <span className="ml-2 text-blue-500">Boundary: {formatTime(dragPreviewTime)}</span>
          )}
        </div>
        <div
          ref={coverageBarRef}
        ...
        >
          {/* Segment fills */}
          {getDisplaySegments().map((segment) => {
