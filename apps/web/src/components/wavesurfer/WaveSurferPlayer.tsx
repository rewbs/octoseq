...
export const WaveSurferPlayer = forwardRef<WaveSurferPlayerHandle, WaveSurferPlayerProps>(function WaveSurferPlayer(
    ...
    const overlayWidth = (viewport?.containerWidthPx ?? 0) || (containerEl?.clientWidth ?? 0);
        ...
        <div className="w-full">
            ...
            >
                ...
                <div className="relative">
                    ...
                    />
                    <HeatmapPlayheadOverlay viewport={viewport ?? null} timeSec={overlayTimeSec} height={height} widthPx={overlayWidth} />
                </div>
