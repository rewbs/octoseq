...
import type { BandMir1DResult, BandCqt1DResult } from "@octoseq/mir";
  ...
  return (
    <div className="relative border-b border-zinc-200 dark:border-zinc-800 last:border-b-0">
      ...
      >
        ...
        {showEvents && (
          <BandEventCountBadge eventData={eventData} color={color} visible={isEventVisible} />
        )}
        {hasWarnings && (
      ...
      {hoverInfo && hoverInfo.value !== null && (
        <div
          ...
          style={{
            left: `${Math.min(Math.max(hoverInfo.x, 50), hoverInfo.containerWidth - 50)}px`,
