...
// ----------------------------
// FrequencyBandContent Component
// ----------------------------

export type FrequencyBandContentProps = {
  /** Audio duration for creating new bands. */
  audioDuration: number;
  /** The audio source ID this panel is scoped to. Defaults to "mixdown". */
  sourceId?: string;
};
...
export function FrequencyBandContent({ audioDuration, sourceId = "mixdown" }: FrequencyBandContentProps) {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="p-2 space-y-2">
        <div className="flex gap-2">
          ...
          <Button
            ...
            size="sm"
            className="flex-1"
            onClick={handleAddStandardBands}
            disabled={audioDuration <= 0}
            title="Add standard 6-band frequency split (Sub Bass, Bass, Low Mids, Mids, High Mids, Highs)"
          >
      ...
      {selectedBand && (
        <div className="border-t border-zinc-200 dark:border-zinc-800 mt-2 pt-2 shrink-0 max-h-75 overflow-hidden flex flex-col">
          <KeyframeTable
            band={selectedBand}
